...
export default function MessageInput({ inputRef, value, onChange, onSend, loading, listening, onVoiceToggle, suggestions = [], onSuggestion }) {
  ...
  return <div className="composer">
    ...
    <div className="input-bar">
      ...
      <button type="button" className={`input-action mic-button ${listening ? "active" : ""}`} onClick={onVoiceToggle} disabled={loading} aria-label={listening ? "Stop listening and ask" : "Start listening"}><AppIcon name="mic" size={20} /></button>
